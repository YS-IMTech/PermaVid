...
from diffsynth.trainers.unified_dataset_ue import UnifiedDataset, LoadVideo, ImageCropAndResize, ToAbsolutePath, Loadcoord, LoadPose2coord, LoadPosejson2coord
...
class WanTrainingModule(DiffusionTrainingModule):
    def __init__(
        ...
        tokenizer_config = ModelConfig(path=tokenizer_path) if tokenizer_path else ModelConfig(model_id="Wan-AI/Wan2.1-T2V-1.3B", origin_file_pattern="google/*")
    ...
    def forward_preprocess(self, data):
        ...
        if self.train_mode == "onlycam": #["onlycam", "memo_rgb", "memo_mix"]
            ...
            memory_end_idx = None
            print("train_mode:",self.train_mode, "video len:", len(data["video"]), "pose len:", len(data["poses"]), "gen num_frames:", num_frames, "raw_num_frames:", raw_num_frames, "gen_start_idx:", gen_start_idx, "gen_end_idx:", gen_end_idx)
            # print("gen_end_idx:", gen_end_idx)


        elif self.train_mode == "memo_rgb":
            gen_start_idx = random.randint(50, raw_num_frames - num_frames - 1)
            gen_end_idx = gen_start_idx + num_frames
...
if __name__ == "__main__":
    ...
    parser.add_argument("--tokenizer_path", type=str, default=None, help="Local path to tokenizer directory (e.g. google/umt5-xxl)")
    ...
    parser.add_argument("--max_nums", type=int, default=1000)
    ...
    dataset = UnifiedDataset(
        ...
        special_operator_map={
            "poses": ToAbsolutePath(args.dataset_base_path) >> Loadcoord(args.num_frames, 
                                                                         intrinsic = [0.5, 0.8667, 0.5, 0.5],
                                                                         orig_intrinsic=True,
                                                                         max_length=args.max_nums)
