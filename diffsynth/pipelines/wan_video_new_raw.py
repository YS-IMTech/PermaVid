...
class WanVideoPipeline(BasePipeline):
    ...
    def __call__(
        ...
        print("original_pose_height:", original_pose_height, "original_pose_width:", original_pose_width)
        ...
        print(f"original_pose_height:{inputs_shared['original_pose_height']}  original_pose_width:{inputs_shared['original_pose_width']} ")
...
class WanVideoUnit_InputVideoEmbedder(PipelineUnit):
    ...
    def process(self, pipe: WanVideoPipeline, input_video, noise, tiled, tile_size, tile_stride, vace_reference_image):
        ...
        if vace_reference_image is not None:
            ...
            print("vace_reference_latents:", vace_reference_latents.shape, "input_latents:", input_latents.shape)
...
class WanVideoUnit_FunCameraControl(PipelineUnit):
    ...
    def process(self, pipe: WanVideoPipeline, height, width, 
        ...
        # print(f"111 height:{height} width:{width} num_frames:{num_frames} original_pose_height:{original_pose_height} original_pose_width:{original_pose_width} \
    ...
    def process(
        ...
        if vace_video is not None or vace_video_mask is not None or vace_reference_image is not None:
            ...
            if vace_video_mask is None:
                ...
                print("vace_video_mask not none:", vace_video_mask is not None)
            ...
            if vace_reference_image is None:
                ...
                print("vace_reference_image:", vace_reference_image[0].size)
                ...
                # print("vace_reference_image:", len(vace_reference_image), vace_reference_image[0].shape)
                ...
                print("vace_reference_latents:",  vace_reference_latents.shape)
                print("vace_video_latents:",  vace_video_latents.shape)
                ...
                vace_mask_latents = torch.concat((torch.zeros_like(vace_mask_latents[:, :, :f]), vace_mask_latents), dim=2) #[1, 64, 36, 60, 104]
